...
export const SHOT_RANGE = 360
export const LONG_SHOT_RANGE = 540
export const ENEMY_SHOT_RANGE = 600
export const WALL_HEALTH = 12
export const enemyHealth = kind => kind === 'spitter' ? 6 : 4
