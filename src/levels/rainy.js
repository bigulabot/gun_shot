...
// with Finlay's Hatters and Spikies. Instead of a wall to shoot down there is
...
//
// Pacing:
//   0–1420     meet a Hatter (hops at you), first small gap
//   1420–2900  ledges with loot, a Snapper, the first Spiky, another Hatter
//   3030–3900  a Spitter, then the checkpoint flag
//   3900–4420  the key: ride the raft, jump up to the key ledge, drop back on
//   4420–5600  heart up high, a Spiky and a Hatter guard the locked door
//   5740–7400  climb to a bonus Hatter and a secret stash, then home
export default {
  id: '02',
  name: 'RAINY RIDGE',
  width: 7400,
  ...
  ledges: [
    ...
    [4650, 466, 150], // heart
    [6250, 466, 140], [6380, 380, 190], // steps up to the bonus Hatter
  ],
  ...
  // it stands on (leave out for the ground)]. Hatters hop, but never out of
  // their patrol area.
  enemies: [
    [1000, 'hatter', 880, 1180],
    [2000, 'snapper', 1900, 2150], [2500, 'spiky', 2500, 2500], [2760, 'hatter', 2660, 2840],
    [3300, 'spitter', 3300, 3300],
    [4950, 'spiky', 4950, 4950], [5200, 'hatter', 5120, 5300],
    [6000, 'snapper', 5900, 6150],
    [6475, 'hatter', 6440, 6510, 380], // bonus, up high
  ],
  ...
  pickups: [
    ...
    [6300, 430, 'research'],
    // Secret stash inside the cloud by the bonus Hatter
  ...
  tips: [
    ...
    [980, 160, 'HATTERS HOP · SHOOT THEM WHEN THEY LAND'],
    [2380, 170, 'SPIKIES CURL UP · WAIT, THEN SHOOT'],
